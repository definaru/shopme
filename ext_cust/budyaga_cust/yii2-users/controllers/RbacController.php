...
class RbacController extends Controller
{
    public function behaviors()
    {
        return [
            ...
            'access' => [
                ...
                'only' => ['index', 'create', 'children', 'update', 'delete'],
                'rules' => [
                    ['actions' => ['index'], 'allow' => true, 'roles' => ['@'],],
                    ['actions' => ['create'], 'allow' => true, 'roles' => ['@'],],
                    ['actions' => ['children'], 'allow' => true, 'roles' => ['@'],],
    ...
    {
        $className = 'budyaga_cust\\users\\models\\' . $this->getModelName($type);
        $model = new $className;
    ...
    public function actionChildren($id, $type)
    {
        ...
        $modelForm->model = $this->findModel($id, 'budyaga_cust\\users\\models\\AuthItem');
