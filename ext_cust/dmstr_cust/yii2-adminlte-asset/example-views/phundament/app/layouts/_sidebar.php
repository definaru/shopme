...
foreach (\dmstr_cust\helpers\Metadata::getModules() as $name => $module) {
    $role                        = $name;
    ...
    switch (true) {
        case (!empty($moduleConfigItem)):
            ...
            $moduleConfigItem['visible'] = \dmstr_cust\helpers\RouteAccess::can($moduleConfigItem['url']);
...
echo dmstr_cust\widgets\Menu::widget([
