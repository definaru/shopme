                ...
                <div class="form-group breadcrum-right">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" href="/support/chat">Chat</a>
                            ...
                            <div class="card-body">
                                ...
                                <div class="supporter-details mt-2">
                                    <div class="supporter-img d-inline-block">
                                        <img class="rounded-circle" src="/panel/images/portrait/small/avatar-s-1.png" alt="Avatar">
                                    </div>
                    ...
                    <div class="col-xl-9 col-md-7 col-12">
                        <div class="card bg-transparent border-0 shadow-none collapse-icon accordion-icon-rotate">
                            <div class="card-body p-0">
                                <div class="accordion search-content-info" id="accordionExample" data-toggle-hover="true">
