$(function () {
    ...
    $(window).on('load', function () {
        ...
        setTimeout(function () {
            ...
            $('link[id="style_sheet"]').attr('href', '/rm/assets/css/skins/default.css');
        }, 1000);
        ...
        if(windowWidth > 992) {
            if ($(document).scrollTop() >= 100) {
                ...
                if($('.do-sticky').length < 1) {
                    $('.logo img').attr('src', '/rm/assets/img/logos/black-logo.png');
                }
            }
            else {
                $('.sticky-header').removeClass('header-shrink');
                if($('.do-sticky').length < 1) {
                    $('.logo img').attr('src', '/rm/assets/img/logos/logo.png');
                }
            }
        } else {
            $('.logo img').attr('src', '/rm/assets/img/logos/black-logo.png');
   ...
   $(".dropdown").on('hover', function () {
    ...
    function populateColorPlates() {
        var plateStings = '<div class="option-panel option-panel-collased d-none">\n' +
            '    <h2>Change Color</h2>\n' +
