    ...
    return (
        <Disclosure as="section" className="bg-gray-50 py-6 px-4 md:px-0 md:py-20">
            ...
            <div className="max-w-6xl mx-auto md:px-4 sm:px-6">
                <div className="flex flex-col bg-white rounded-3xl p-6 md:p-10 shadow-xl">
                    <div className="flex justify-center">
                        <h2 className="text-2xl md:text-5xl text-gray-900 font-extrabold mb-3">Остались вопросы?</h2>
                    </div>
                    <div className="flex justify-center text-gray-600 text-center">
                        <p>
                            Напишите нам на&#160;
                            <a href="mailto:info@shopme.su" className="no-underline hover:underline">
                                info@shopme.su
                            </a>, 
                            ответим обязательно
                        </p>
